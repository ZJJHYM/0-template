...
def parse_input_json(input_json, tag_dict):
    ...
    for video in pred_result:
        ...
        pred_dict[video] = convert_to_hot(
            pred_result[video]["result"][0]["labels"],
            pred_result[video]["result"][0]["scores"],
            tag_dict,
        )
    return pred_dict
...
if __name__ == "__main__":
    ...
    assert os.path.exists(args.tag_id_file), "dict file {} not found".format(
        args.tag_id_file
    )
